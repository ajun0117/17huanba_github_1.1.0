...
- (void)startAuthorize
{
    ...
    */
    ...
    aCtrl.delegate = self;
    aCtrl.title = @"绑定新浪微博";
    aCtrl.shareType = SinaWeibo;
    aCtrl.authorizeURL = [NSURL URLWithString:urlString];
    [rootViewController.navigationController pushViewController:aCtrl animated:YES];
    [aCtrl release];
    //
}
...
// 2012-09-13, ChenXin added
#pragma mark - KYAuthorizeDelegate Methods
